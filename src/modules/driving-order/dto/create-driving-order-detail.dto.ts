...
export class CreateDrivingOrderDetailDto {
...
export class CreateDrivingOrderDetailsDto {
    @ApiProperty({ type: [CreateDrivingOrderDetailDto] })
    @ArrayNotEmpty({ message: 'Danh sách không được để trống' })
    details: CreateDrivingOrderDetailDto[];
}
